...
def main(argv: list[str] | None = None) -> int:
    ...
    run.add_argument("--candidate-role", required=True, choices=("frontend_builder", "backend_builder", "domain_builder", "integrator", "governance_maintainer"))
    run.add_argument("--task-id", required=True, help="Task Contract identifier resolved from the trusted verification baseline")
